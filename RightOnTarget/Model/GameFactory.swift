...
//
//  Класс GameFactory создан в соответствии с паттерном "Абстрактная фабрика". Используется в качестве единой точки создания экземпляров класса Game для использования в программе
